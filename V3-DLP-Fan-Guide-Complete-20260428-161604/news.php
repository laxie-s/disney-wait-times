...
<main class="page-main">
    <section class="shell page-hero">
        <div class="section-head">
            ...
            <h1>Une rubrique editoriale pour suivre un resort en vraie mutation.</h1>
            <p>Le retour en force du deuxieme parc change la maniere meme de raconter la destination. On peut maintenant lire les actus par parc.</p>
        </div>

        <nav class="chip-nav" aria-label="Filtre par parc">
            <a href="news.php" class="chip-link <?php echo $park_choisi === null ? 'active' : ''; ?>">Tout</a>
            <?php foreach ($allowed_news_parks as $parkName) : ?>
                <a href="news.php?park=<?php echo urlencode($parkName); ?>" class="chip-link <?php echo $park_choisi === $parkName ? 'active' : ''; ?>">
                    <?php echo e($parkName); ?>
                </a>
            <?php endforeach; ?>
        </nav>
